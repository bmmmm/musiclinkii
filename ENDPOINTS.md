...
| `huggingface.co/Xenova/dinov2-small/resolve/main/…` | q4 DINOv2-small configuration, processor and ONNX weights (15,035,808 bytes total); conversion of Meta's Apache-2.0 base model; downloaded by an explicit model button or visual comparison and persisted in the app-owned `musiclinkii-visual-model-v1` Cache Storage until its delete button or browser site-data controls remove it | ordinary model asset requests, **never the selected image** | 2026-09-04 (official repository file API and real Chrome comparison) | `js/visual-match.mjs` `loadExtractor` | [conversion files](https://huggingface.co/Xenova/dinov2-small), [q4 weights](https://huggingface.co/Xenova/dinov2-small/blob/main/onnx/model_q4.onnx), [base-model license](https://huggingface.co/facebook/dinov2-small) |
